...
3.  Terminal: ionic add ionic-platform-web-client
4.  Terminal: ionic plugin add ionic-plugin-deploy
5.  If you have not already, be sure to include SSFConfig.js or this will not work with all the features it has.
    ...
    template: 
      '<ion-view hide-nav-bar="true">' +
        '<ion-content class="padding calm-bg" style="text-align:center;">' +
            '<h3 class="white" style="margin-top: 30px;">Updating...</h3>' +
